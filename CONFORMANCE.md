...
| **`CONF-06`** | **Bounded Rehydration Cap** | Invariant 4 (Bounded) | On-demand hydration cannot exceed `max_rehydration_tokens` (default: 3000 tokens). | Calls exceeding limit are chunked or bounded with explicit truncation warning. |
